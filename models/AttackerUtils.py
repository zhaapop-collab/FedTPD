...
from models.Nets import ResNet18, vgg19_bn, vgg19, get_model, ResNet18_cifar100, EfficientNetB0, ResNet18_FashionMNIST
...
def get_key_value_bsr(model_param, args, mal_train_dataset, mal_val_dataset):
    if args.model == 'resnet' and args.dataset == 'cifar':
        ...
        model = ResNet18_cifar100().to(args.device)
    elif args.model == 'EfficientNet':
        model = EfficientNetB0().to(args.device)
    elif args.model == "resnet" and args.dataset == 'fashion_mnist':
        model = ResNet18_FashionMNIST().to(args.device)
    param1 = model_param
    model.load_state_dict(param1)
